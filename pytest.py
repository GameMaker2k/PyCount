...
if (len(sys.argv) == 3):
    print("Executing %s with argument %s,%s" %
          (sys.argv[0], sys.argv[1], sys.argv[2]))
if (len(sys.argv) == 4):
    print("Executing %s with argument %s,%s,%s" %
          (sys.argv[0], sys.argv[1], sys.argv[2], sys.argv[3]))
if (len(sys.argv) == 5):
    print("Executing %s with argument %s,%s,%s,%s" %
          (sys.argv[0], sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]))
    fp.write("Executing %s with argument %s,%s,%s,%s" %
             (sys.argv[0], sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]))
